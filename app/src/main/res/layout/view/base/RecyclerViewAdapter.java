...
public final class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewItemHolder> {
  ...
  @Override
  public RecyclerViewItemHolder onCreateViewHolder(final ViewGroup parentView, final int layoutId) {
  ...
  @Override
  public void onBindViewHolder(final RecyclerViewItemHolder viewHolder, final int position) {
